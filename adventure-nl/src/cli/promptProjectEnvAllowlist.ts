...
export const PROMPT_PROJECT_ENV_ALLOWLIST: ReadonlySet<string> = new Set([
  "ADVENTURE_NL_AUTOPLAY_PROMPT_MODE",
  "ADVENTURE_NL_COMPACT_PROMPTS",
  "ADVENTURE_NL_STRUCTURED_PROMPTS",
  "ADVENTURE_NL_FAST_INTERPRET",
  "ADVENTURE_NL_INTERPRET_PROMPT_EXAMPLES",
  "ADVENTURE_NL_AUTOPLAY_TWO_STEP",
  "ADVENTURE_NL_DIAGONAL_COMPASS_MOTION",
  "ADVENTURE_NL_MLX_SYSTEM_VARIANT",
  "ADVENTURE_NL_VOCAB_HINT_MAX",
]);
