import type { AutoplayPromptMode } from "@adventure-nl/nl-glue";
...
const registry: Readonly<Record<string, AutoplayStrategyHooks>> = {
  ...
  explore: {
    id: "explore",
    promptMode: "explore",
    defaultEnvAllowlist: { ADVENTURE_NL_AUTOPLAY_PROMPT_MODE: "explore" },
  },
  full: {
    id: "full",
    promptMode: "full",
    defaultEnvAllowlist: { ADVENTURE_NL_AUTOPLAY_PROMPT_MODE: "full" },
  },
};
