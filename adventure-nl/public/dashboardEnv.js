...
export function resolveDashboardElements(doc) {
  return {
    ...
    mapTabBtnMermaid: doc.getElementById("tab-btn-mermaid"),
    mapTabBtnXstate: doc.getElementById("tab-btn-xstate"),
    mapTabPanelMermaid: doc.getElementById("tab-panel-mermaid"),
    mapTabPanelXstate: doc.getElementById("tab-panel-xstate"),
    statelyInspectIframe: doc.getElementById("stately-inspect-iframe"),
