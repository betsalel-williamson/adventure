 ...
 *
 * @env ADVENTURE_NL_DIAGONAL_COMPASS_MOTION — `1`, `true`, or `yes` enables. Unset or other values: disabled.
 */
export function isDiagonalCompassMotionEnabled() {
    const v = typeof process !== "undefined" && process.env !== undefined
        ? process.env.ADVENTURE_NL_DIAGONAL_COMPASS_MOTION?.trim().toLowerCase()
        : undefined;
