 ...
 */
export type PlannerUserPromptInput = string | {
...
export type TextLlm = {
    ...
    interpretPlayerInput(userText: string, db: AdventureDatabase, options: InterpretPlayerInputOptions): Promise<InterpretedCommand>;
    planAutoplay(db: AdventureDatabase, options: {
...
//# sourceMappingURL=textLlmContract.d.ts.map