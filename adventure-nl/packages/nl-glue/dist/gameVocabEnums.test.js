...
import { collectGameVocabTokens, openAiAutoplayPlannerJsonSchema, openAiInterpretCommandJsonSchema, vocabTokensForLlmEnums, } from "@adventure-llm/nl-glue";
...
describe("gameVocabEnums", () => {
    ...
    it("OpenAI strict schemas reference only enum tokens", () => {
        ...
        const p = interpret.properties;
        expect(p.primaryToken.enum?.length).toBe(tokens.length);
    });
});
//# sourceMappingURL=gameVocabEnums.test.js.map