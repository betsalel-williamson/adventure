...
import { InferredExplorationMap, inferredMapToDot, inferredMapToLocalDot, inferredMapToMermaid, interpretedToGetinLine, } from "@adventure-llm/nl-glue";
...
describe("explorationGraphViz", () => {
    ...
    it("removes a taken object from room takeable list after OK TAKE", () => {
        ...
        const snap = m.toSnapshot();
        const building = snap.cells.find((c) => c.x === 1 && c.y === 0 && c.z === 0);
...
//# sourceMappingURL=explorationGraphViz.test.js.map