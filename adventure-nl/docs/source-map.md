...
| **ADRs**           | `docs/decisions/ADR0001-adventure-nl-text-llm-providers.md`, `ADR0002`, `ADR0003`                                         |
| **Guidelines**     | `guidelines/adventure-nl/autoplay-planner-context.md`                                                                     |
| **Package README** | `adventure-nl/README.md`                                                                                                  |
| **This map**       | `adventure-nl/docs/source-map.md`                                                                                         |
| **Work items**     | `.work-items/adventure-nl/design.md`, related task markdown                                                               |
