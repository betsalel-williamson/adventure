...
**Adventure v2** historical plans: [slice 2 — HTTP/SSE](../../.cursor/plans/adventure-v2-slice-2-http-sse_f4a2b91c.plan.md); [slice 1 — minimal milestones](../../.cursor/plans/adventure-v2-minimal-milestones_cba1cb3e.plan.md) (M1–M8 **complete**). **Slice 4 (retrospective):** process oracle bridge is implemented in-tree — [`adventure-v2/apps/server/src/oracle/processOracleBridge.ts`](../../adventure-v2/apps/server/src/oracle/processOracleBridge.ts), [`oracle-subprocess-ipc.md`](../../docs/architecture/adventure-v2/oracle-subprocess-ipc.md), tests under `adventure-v2/tests/`. **Slice 5** ([`adventure-v2-slice-5-r4-web-observability`](../../.cursor/plans/adventure-v2-slice-5-r4-web-observability.plan.md)) **complete**. **Active slice** is in the planning index snapshot (**slice 6 — R4 cognition trace**: [`adventure-v2-slice-6-r4-cognition-trace.plan.md`](adventure-v2-slice-6-r4-cognition-trace.plan.md)).
