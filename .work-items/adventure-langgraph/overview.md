...
**CRT-first MVP shipped** in-repo: [`adventure-v3/README.md`](../../adventure-langgraph/README.md) documents the shell talking to the adventure-v2 HTTP + SSE API with honest status and wire tests. Planning docs ([epics/index.md](epics/index.md), [stories/](stories/)) track **what end users see next**.
