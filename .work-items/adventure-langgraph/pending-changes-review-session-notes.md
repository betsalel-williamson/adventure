...
- [ ] **Demo A — Synthetic:** `ADV_V2_DISABLE_AUTO_FORTRAN_ORACLE=1` API + v3 shell (`cd adventure-langgraph && npm start` or `npm run dev`) — sparse oracle, status strip matches `GET /health`.
