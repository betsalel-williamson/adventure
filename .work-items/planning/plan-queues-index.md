...
| **Plan / slice** | **Slice 13** (LangGraph + XState + cognition traces, [`slice-13-multidisciplinary-review.md`](../adventure-v2/slice-13-multidisciplinary-review.md)) **shipped**; prior **slice 12** (CORS); **slice 11** (operational readiness); slices **10** (R5 HTTP wire), **9** (HTTP Gherkin + CI Cucumber), **8** (R3 reconcile visibility); slice **7** (Fortran oracle CI): [`.github/workflows/adventure-v2.yml`](../../.github/workflows/adventure-v2.yml). |
| **Blocking** | _(none)_ |
...
- **Adventure v2 (post–slice 13)** — follow README **Not yet** and planning snapshot **Next after this**.
