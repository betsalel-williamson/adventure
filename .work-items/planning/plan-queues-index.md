...
| **Plan / slice** | **Slice 17** (web shell modularity, UX prep U3–U5): [`slice-17-multidisciplinary-review.md`](../adventure-v2/slice-17-multidisciplinary-review.md), plan [`adventure-v2-slice-17-web-shell-modularity-ux.plan.md`](../adventure-v2/adventure-v2-slice-17-web-shell-modularity-ux.plan.md). Prior **slice 16** (CRT shell, Mermaid, cognition trace): [`slice-16-multidisciplinary-review.md`](../adventure-v2/slice-16-multidisciplinary-review.md); **slice 15** (virtual terminal lane); **slice 14** (interactive shell); **slice 13** (LangGraph + XState); **slice 12** (CORS); slice **7** (Fortran oracle CI): [`.github/workflows/adventure-v2.yml`](../../.github/workflows/adventure-v2.yml). |
| **Blocking** | _(none)_ |
...
- **Adventure v2 slice 12** (retrospective) — **`ADV_V2_CORS_ORIGINS`** allowlist + `corsHeadersForRequest`: [`createServer.ts`](../../adventure-v2/apps/server/src/http/createServer.ts), [`http.acceptance.test.ts`](../../adventure-v2/tests/http.acceptance.test.ts), README + [`design.md`](../adventure-v2/design.md) §3.1, [`slice-12-multidisciplinary-review.md`](../adventure-v2/slice-12-multidisciplinary-review.md), archive pointer [`adventure-v2-slice-12-configurable-cors.plan.md`](../adventure-v2/adventure-v2-slice-12-configurable-cors.plan.md); **superseded for focus** by slice 13 (LangGraph + XState)
- **Adventure v2 slice 13** (retrospective) — LangGraph (`runTurnBrainGraph`), xstate control machine, extended **`CognitionTraceWire`**, async **`processTurn`**, 10 SSE events/turn: [`runTurnBrainGraph.ts`](../../adventure-v2/packages/cognition/src/brain/runTurnBrainGraph.ts), [`controlMachine.ts`](../../adventure-v2/packages/control/src/machine/controlMachine.ts), [`runCoordinator.ts`](../../adventure-v2/apps/server/src/run/runCoordinator.ts), [`wire.ts`](../../adventure-v2/packages/contracts/src/http/wire.ts), HTTP + Cucumber + [`slice-13-multidisciplinary-review.md`](../adventure-v2/slice-13-multidisciplinary-review.md), archive [`adventure-v2-slice-13-langgraph-xstate.plan.md`](../adventure-v2/adventure-v2-slice-13-langgraph-xstate.plan.md); **superseded for focus** by slice 14 (MVP shell)
- **Adventure v2 slice 14** (retrospective) — Interactive web shell (`main.ts`, `index.html`), **`promptSystem`** / **`promptUser`** on **`CognitionTraceWire`**, **`capPromptTextForWire`**, stub autoplay (`stubAutoplayPlanner.ts`), multi-turn HTTP acceptance, docs: [`slice-14-multidisciplinary-review.md`](../adventure-v2/slice-14-multidisciplinary-review.md); **superseded for focus** by slice 15 (virtual terminal)
- **Adventure v2 slice 15** (retrospective) — Virtual terminal lane (`formatVirtualTerminal*` in **`wireDisplay.ts`**, game terminal UI + raw SSE toggle), README **v1-like terminal MVP** + Fortran table: [`slice-15-multidisciplinary-review.md`](../adventure-v2/slice-15-multidisciplinary-review.md); **superseded for focus** by slice 16–17
- **Adventure v2 slice 16** (retrospective) — CRT game terminal, **`appendCognitionTraceEntry`**, Mermaid agent diagrams + codegen, stub autoplay 10 moves: [`slice-16-multidisciplinary-review.md`](../adventure-v2/slice-16-multidisciplinary-review.md); **superseded for focus** by slice 17
- **Adventure v2 slice 17** — Web shell modularity (`agentDiagramPanel`, `gameTerminalBuffer`, `runCheckpointsApi`, `shellUiPreferences`) + UX prep **U3–U5**: [`adventure-v2-slice-17-web-shell-modularity-ux.plan.md`](../adventure-v2/adventure-v2-slice-17-web-shell-modularity-ux.plan.md), [`slice-17-multidisciplinary-review.md`](../adventure-v2/slice-17-multidisciplinary-review.md)
