...
| **Plan / slice** | **Slice 15** (virtual terminal lane, README Fortran/MVP parity): [`slice-15-multidisciplinary-review.md`](../adventure-v2/slice-15-multidisciplinary-review.md). Prior **slice 14** (interactive shell, full prompts, stub autoplay): [`slice-14-multidisciplinary-review.md`](../adventure-v2/slice-14-multidisciplinary-review.md); **slice 13** (LangGraph + XState + traces); **slice 12** (CORS); slice **7** (Fortran oracle CI): [`.github/workflows/adventure-v2.yml`](../../.github/workflows/adventure-v2.yml). |
| **Blocking** | _(none)_ |
