...
| **Plan / slice** | **Slice 16** (CRT shell, Mermaid agent diagrams, accumulated cognition trace, autoplay 10 moves): [`slice-16-multidisciplinary-review.md`](../adventure-v2/slice-16-multidisciplinary-review.md). Prior **slice 15** (virtual terminal lane): [`slice-15-multidisciplinary-review.md`](../adventure-v2/slice-15-multidisciplinary-review.md); **slice 14** (interactive shell); **slice 13** (LangGraph + XState + traces); **slice 12** (CORS); slice **7** (Fortran oracle CI): [`.github/workflows/adventure-v2.yml`](../../.github/workflows/adventure-v2.yml). |
| **Blocking** | _(none)_ |
...
- **Adventure v2 UX review follow-through** — after the multidisciplinary session, execute incremental steps **U1–U7** in [`.work-items/adventure-v2/ux-multidisciplinary-review-prep.md`](../adventure-v2/ux-multidisciplinary-review-prep.md) §5 (prep doc ties to [UX multidisciplinary review plan](../../.cursor/plans/ux_multidisciplinary_review_prep_e322a643.plan.md)); **U6** blocked until ModelAdapter / run config is honored server-side.
...
- **Adventure v2 slice 15** (retrospective) — Virtual terminal lane (`formatVirtualTerminal*` in **`wireDisplay.ts`**, game terminal UI + raw SSE toggle), README **v1-like terminal MVP** + Fortran table: [`slice-15-multidisciplinary-review.md`](../adventure-v2/slice-15-multidisciplinary-review.md); **next focus** per README **Not yet**
