...
| --- | --- | --- |
| 1 | [overview.md](overview.md) | Status, non‑negotiable rule, audience |
| 2 | [lessons-from-v2.md](lessons-from-v2.md) | Why v2 is not the demo path; v1 vs v2 context |
| 3 | [epics/index.md](epics/index.md) | Epic catalog and traceability to user stories |
| 4 | [stories/](stories/) | One file per user story (role line + EARS acceptance criteria) |
| 5 | [design-agentic-mvp.md](design-agentic-mvp.md) | Technical design for E4/E5 agent assists (boundaries, posture routing, map pipeline) |
| 6 | [deferred.md](deferred.md) | Explicitly out of scope for “first useful ship”; ancillary panel rules |
| 7 | [roadmap-next-features.md](roadmap-next-features.md) | Candidate next features (not commitments) |
...
The former single file [`lessons-learned-and-v3-backlog.md`](lessons-learned-and-v3-backlog.md) now redirects here.
