 ...
 * Run from adventure-llm: `npm run build && node scripts/print-mlx-system-prompts.mjs`
 *
 * For live model comparison (one MLX load, four planner calls): `npm run experiment:mlx-system-smoke`
 * Or per-run autoplay: `ADVENTURE_LLM_MLX_SYSTEM_VARIANT=compact npm start -- --autoplay`
 */
import {
