...
export const PROMPT_PROJECT_ENV_ALLOWLIST: ReadonlySet<string> = new Set([
  "ADVENTURE_LLM_AUTOPLAY_PROMPT_MODE",
  "ADVENTURE_LLM_COMPACT_PROMPTS",
  "ADVENTURE_LLM_STRUCTURED_PROMPTS",
  "ADVENTURE_LLM_FAST_INTERPRET",
  "ADVENTURE_LLM_INTERPRET_PROMPT_EXAMPLES",
  "ADVENTURE_LLM_AUTOPLAY_TWO_STEP",
  "ADVENTURE_LLM_DIAGONAL_COMPASS_MOTION",
  "ADVENTURE_LLM_MLX_SYSTEM_VARIANT",
  "ADVENTURE_LLM_VOCAB_HINT_MAX",
]);
