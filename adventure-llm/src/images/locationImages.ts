 ...
 */
export function locationImageCacheKey(
  loc: number,
...
/**
 * Placeholder for Gemini image integration: returns null unless enabled and file exists.
 * When implementing generation, use the model from `resolvedGeminiImageModel()` in `nl/geminiModels.ts`
