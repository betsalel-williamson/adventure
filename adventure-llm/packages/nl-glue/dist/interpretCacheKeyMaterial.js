 ...
 */
export function interpretCacheSchemaVersion() {
 ...
 */
export function interpretCacheKeyMaterialHash(parts) {
    return createHash("sha256")
        .update(["interpret", interpretCacheSchemaVersion(), ...parts].join("\u001e"), "utf8")
        .digest("hex");
}
//# sourceMappingURL=interpretCacheKeyMaterial.js.map