...
<!-- Link one primary issue; use Closes #N only when acceptance criteria are verified -->

- Closes #
- Part of #3 (cloud deploy MVP epic)
...
- [ ] Shards / OpenAPI updated if behavior or contracts changed
- [ ] `make docs-check` (if docs touched)
