...
| [adventure-v2/overview.md](./adventure-v2/overview.md)                                               | **`adventure-v2` (planned v2 project)**: separate monorepo runtime for benchmark orchestration with LangGraph cognition, XState control loops, replay/checkpoint contracts, console-first observability UX, and explicit model categories (`SLM`, `LLM`, `API`, `MLX`).                         |
...
- **Planned v2 project**: [`adventure-v2/`](../../adventure-v2/) — separate frontend/backend/shared packages (web, server, contracts, cognition, control) documented under [`docs/architecture/adventure-v2/`](./adventure-v2/overview.md).
