...
| **Audit and replay**       | Subsystem history in **SQLite WAL** on the client; **revisions** and **tags** ([ADR0006](../decisions/ADR0006-client-sqlite-wal-subsystem-store.md), [ADR0007](../decisions/ADR0007-subsystem-revision-control-and-replay.md)). The **subsystem store** schema and API exist under [`adventure-llm/src/browser/`](../../adventure-llm/src/browser/) (see ADR0006 **Implementation**); **tags** and full replay UX are [ADR0007](../decisions/ADR0007-subsystem-revision-control-and-replay.md). |
...
- **ADR0006–ADR0008** — Client **SQLite WAL** (store module **implemented** — [ADR0006](../decisions/ADR0006-client-sqlite-wal-subsystem-store.md) **Implementation**), **revision control / replay**, **server replica + sync**.
