...
5. [ADR0016](ADR0016-cognition-glue-mcp-and-execution-mcp-surfaces.md) — **Cognition (Glue) MCP** vs **Execution (Game) MCP** surfaces; MCP **2025-11-25** pin; documentation chain + future code steps (**proposed**; see ADR **Implementation**)
...
| Browser autoplay / glue + client cognition loop | ADR0005, **ADR0014** (**accepted** — NL glue **package** + **browser** bundle), **ADR0015** (**accepted** — deprecate server-forward NL for dashboard default), **ADR0016** (**proposed** — Glue vs Execution **MCP** surfaces + doc chain) |
