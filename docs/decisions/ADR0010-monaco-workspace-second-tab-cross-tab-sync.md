...
Monaco Editor is the practical “VS Code–like” surface without hosting full VS Code. Cross-tab coordination uses **BroadcastChannel**; same-origin tabs share cookies ([`webDashboardSession.ts`](../../adventure-nl/src/cli/webDashboardSession.ts)).
...
- `adventure-nl/public/index.html`
...
- **See also:** [ADR0016](ADR0016-cognition-glue-mcp-and-execution-mcp-surfaces.md) — orchestration / Glue MCP does not run inside the workspace tab; workspace **notifies** the host.
