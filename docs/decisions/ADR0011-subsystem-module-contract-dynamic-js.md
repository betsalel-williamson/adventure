...
- **Authors** want to write **plain JavaScript** subsystems that plug into **browser-orchestrated glue and policy** ([ADR0005](ADR0005-browser-orchestrated-autoplay-cognition.md))—map/inventory/mode hooks, prompt shaping—with a **small, documented API**—not fork the whole `adventure-nl` repo.
