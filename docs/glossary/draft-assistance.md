...
Draft assistance must be visually and verbally distinct from oracle room descriptions. When assist is unreachable, the client falls back to deterministic merge in `@adventure-v3/map-core` — still draft, not oracle truth.
