...
Defaults favor **game-first** play: exploration map and location agent on; legacy Assist panels off.
...
Product behavior: [`docs/features/crt-shell.md`](../docs/_build/features-v3.md#crt-shell). Env overrides and `sessionStorage` keys: [`docs/developer/langgraph-feature-flags.md`](../docs/_build/developer.md#langgraph-feature-flags).
