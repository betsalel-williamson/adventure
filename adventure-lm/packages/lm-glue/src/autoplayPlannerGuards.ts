...
export function planAfterAutoplayGuards(
  ...
  if (
    ...
    log(
      "adventure-lm: autoplay — replaced plan that repeated a parser-rejected GETIN line\n",
    );
  }
  ...
  if (
    ...
    log(
      "adventure-lm: autoplay — replaced plan: TAKE/GET object already in inventory\n",
    );
  }
  ...
  if (
    ...
    log(
      "adventure-lm: autoplay — replaced plan that would continue a two-location loop\n",
    );
  }
  ...
  if (
    ...
    log(
      "adventure-lm: autoplay — replaced plan due to location stagnation (inferred map)\n",
    );
  }
  ...
  if (
    ...
    log(
      "adventure-lm: autoplay — replaced plan: LOOK/EXAMI already used without leaving this room (inferred map)\n",
    );
  }
  return planSafe;
}
