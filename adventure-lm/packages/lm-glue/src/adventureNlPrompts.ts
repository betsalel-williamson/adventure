...
export function resolveInterpretPromptExamples(
  ...
  const v =
    process.env.ADVENTURE_LM_INTERPRET_PROMPT_EXAMPLES?.trim().toLowerCase();
 ...
 */
export const ADVENTURE_LM_INTERPRET_COMPACT_HELP_HINT =
...
export const ADVENTURE_LM_INTERPRET_ROLE =
...
export const ADVENTURE_LM_INTERPRET_ROLE_COMPACT =
...
export const ADVENTURE_LM_AUTOPLAY_PLANNER_ROLE =
...
export const ADVENTURE_LM_AUTOPLAY_PLANNER_ROLE_COMPACT =
...
export function resolveAutoplayPromptMode(): AutoplayPromptMode {
  const v =
    process.env.ADVENTURE_LM_AUTOPLAY_PROMPT_MODE?.trim().toLowerCase();
