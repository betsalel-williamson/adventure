...
import { formatAiGroupedVocabularyHint, pickWordsFromAiGroups, tryLoadAiVocabCategoriesForHint, } from "./vocabAiCategories.js";
...
function bucketForKtab(ktabVal) {
...
function bucketsInTableOrder(db) {
    const buckets = {
        motion: [],
        verb: [],
        object: [],
 ...
 */
function pickWordsFromBuckets(buckets, maxWords) {
    const out = {
        motion: [],
        verb: [],
        object: [],
...
function groupTitle(key, compact) {
    if (compact) {
        const titles = {
            motion: {
                t: "Motion / travel",
...
function formatGroupedHint(picked, options) {
    const lines = [];
...
function buildLegacyFlatHint(db, maxWords) {
    const words = [];
 ...
 */
export function buildVocabHint(db, maxWords, options) {
...
//# sourceMappingURL=vocabHint.js.map