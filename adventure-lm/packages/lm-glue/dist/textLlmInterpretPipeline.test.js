...
import { finalizeAutoplayPlannerResponse, finalizeInterpretedCommand, } from "@adventure-llm/nl-glue";
...
describe("finalizeInterpretedCommand", () => {
    it("snaps unknown primary to fallback and applies repair", () => {
        ...
        const out = finalizeInterpretedCommand(db, "xyzzy", { primaryToken: "ZZZZZ" }, undefined);
...
describe("finalizeAutoplayPlannerResponse", () => {
    it("preserves continuePlaying and coerces tokens", () => {
        const db = loadDatFile(datPath);
        const out = finalizeAutoplayPlannerResponse(db, {
            primaryToken: "ZZZZZ",
...
//# sourceMappingURL=textLlmInterpretPipeline.test.js.map