...
describe("mergeHttpWebPresetsFromEnv", () => {
  ...
  beforeEach(() => {
    ...
    delete process.env.ADVENTURE_LM_HTTP_WEB_PRESETS;
    delete process.env.ADVENTURE_LM_WEB_PRESETS_YAML;
  ...
  it("dedupes env merge and sorts presets A→Z", () => {
    process.env.ADVENTURE_LM_HTTP_MODEL = "a";
    process.env.ADVENTURE_LM_HTTP_WEB_PRESETS = "b, a , c";
  ...
  it("sorts so default HTTP model is not pinned first when not alphabetically first", () => {
    process.env.ADVENTURE_LM_HTTP_MODEL = "zebra";
    process.env.ADVENTURE_LM_HTTP_WEB_PRESETS = "alpha, beta";
  ...
  it("appends providers.http.models from YAML after env merge", () => {
    ...
    process.env.ADVENTURE_LM_WEB_PRESETS_YAML = yamlPath;
    process.env.ADVENTURE_LM_HTTP_MODEL = "a";
    resetTextLlmWebPresetsCacheForTests();
