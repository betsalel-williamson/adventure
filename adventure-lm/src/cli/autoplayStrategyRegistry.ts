import type { AutoplayPromptMode } from "@adventure-lm/lm-glue";
...
const registry: Readonly<Record<string, AutoplayStrategyHooks>> = {
  ...
  explore: {
    id: "explore",
    promptMode: "explore",
    defaultEnvAllowlist: { ADVENTURE_LM_AUTOPLAY_PROMPT_MODE: "explore" },
  },
  full: {
    id: "full",
    promptMode: "full",
    defaultEnvAllowlist: { ADVENTURE_LM_AUTOPLAY_PROMPT_MODE: "full" },
  },
};
