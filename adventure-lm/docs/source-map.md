...
| **ADRs**           | `docs/decisions/ADR0001-adventure-lm-text-llm-providers.md`, `ADR0002`, `ADR0003`                                        |
| **Guidelines**     | `guidelines/adventure-lm/autoplay-planner-context.md`                                                                    |
| **Package README** | `adventure-lm/README.md`                                                                                                 |
| **This map**       | `adventure-lm/docs/source-map.md`                                                                                        |
| **Work items**     | `.work-items/adventure-lm/design.md`, related task markdown                                                              |
